...
[`@aws-sdk/client-translate`](https://www.npmjs.com/package/@aws-sdk/client-translate/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-translate@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mVofBOTYAnsPSlscOSVSTfeLv+iv5TgtuGyneTK1Pal9BHXb55Af58Q3tOb/VgZs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-translate": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-translate@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-translate@3.409.0/index.min.mjs": "sha384-mVofBOTYAnsPSlscOSVSTfeLv+iv5TgtuGyneTK1Pal9BHXb55Af58Q3tOb/VgZs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-translate/blob/refs/tags/3.409.0/LICENSE
```
